...
import { undoDrawing, redoDrawing, initializeDrawing } from "./history.js";
...
const layerVisibilityButton = document.getElementById("layerVisibilityButton");

const allLayerVisibilityButton = document.getElementById(
  "allLayerVisibilityButton",
);
...
screenCaptureButton.addEventListener("click", () => {
